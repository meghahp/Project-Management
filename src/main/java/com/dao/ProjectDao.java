...
public class ProjectDao {
	...
	public void updateProject(ProjectBean project) {
		stmt.update("update project set projecttitle = ?,description= ?,technology= ? where projectid = ? ", project.getProjectTitle(),project.getDescription(),project.getTechnology(),project.getProjectId());
	}
